"""
Django settings for DjangoDeepDive project.
...
SECRET_KEY = 'django-insecure-=f7t=yewh$6gmzs@*84ohhf05vafd2z62-w-^%@453_)s6f-%0'
...
# Django project JWT Coustomizar
...
SIMPLE_JWT = {
    ...
    "AUTH_HEADER_TYPES": ("Bearer",), # HerAder Types
...
ROOT_URLCONF = 'DjangoDeepDive.urls'
...
WSGI_APPLICATION = 'DjangoDeepDive.wsgi.application'
